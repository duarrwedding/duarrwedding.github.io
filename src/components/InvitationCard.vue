  ...
  <div class="section-1">
    ...
    <template v-else>
      ...
      <div class="content-1">
        ...
        />
        <p class="title-1 animate__animated animate__fadeIn animate__delay-1s">
          Rasta & Reyhan
        </p>
        <p
          class="description-1 animate__animated animate__fadeIn animate__delay-1s"
        >
